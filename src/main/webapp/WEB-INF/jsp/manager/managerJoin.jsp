			...
			<div class="text-center" id="joinForm">
				...
				<div id="managerVerifyForm" class="input-group">
					...
					<div class="input-group-append">
						<button type="button" class="btn btn-info" id="verifyBtn">확인</button>
					</div>
				</div>
				
				<div id="managerLoginForm" class="d-none">
	...
	<script>
		$(document).ready(function(){
			...
			$("#verifyBtn").on("click",function(){
				...
				if(key == "root"){
					alert("인증에 성공하였습니다");
					$("#managerLoginForm").removeClass("d-none");
					$("#managerVerifyForm").addClass("d-none");
				} else {
					alert("인증키를 확인해주세요");
					return ;
				}
